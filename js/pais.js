class Pais {
    ...
    getPrevisionTiempo(){
        ...
        //var apiKey = "47b790fd0fc41878c80c57c9846132cb";  //el de cueva
            ...
            success: function(datos){
                    ...
                    //for(let i = 0; i < listaPronosticos.length; i+=8){  //METODO ALTERNATIVO: incremento cada ocho, asi solo coge cada 24 horas
                        if($(listaPronosticos[i]).attr("from").split("T")[1] === horaAMedir){  //filtramos para solo coger tomas a horas concretas de distintos dias
                            ...
                            //ESTAS SON JQUERYS PARA ACCEDER A ATRIBUTOS DEL XML DEVUELTO, siguiendo la forma:
                            // $ es lo mismo que querySelector
                            //"temperature" y similares son la etiqueta que estamos buscando dentro de lo devuelto (listaPronosticos[i])
                            //.attr("value") nos devuelve el valor del ATRIBUTO var dentro de la etiqueta temperature
