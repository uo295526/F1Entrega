...
//REVISAR SI TENERLO AQUI SUELTO O NO
//MAPA DINAMICO
var miMapa = new Object();
var mapaGeoposicionado;

function initMap(){  
    var centro = {lat: 43.3672702, lng: -5.8502461};
    //var mapaGeoposicionado = new google.maps.Map(document.getElementById('mapa'),{

    document.querySelector('div > h5').remove();

    mapaGeoposicionado = new google.maps.Map(document.querySelector('div'),{
