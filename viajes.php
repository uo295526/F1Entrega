...
<body>
        ...
        class Moneda{
            ...
            public function realizarCambioMoneda(){
                ...
                if($respuesta){
                    ...
                    echo "<article>";
                    echo "<h3>Intercambio de moneda local</h3>";
    ...
    <!--<input type="button" value="Obtener mis coordenadas, altitud, rumbo y velocidad" onClick = "viajes.verTodo('ubicacion');"/>-->
    

    <!--NOTA IMP, METER EL H4 DENTRO PORQUE SI NO DA ERROR, Y ESE RESPETE EL GRID LAYOUT DE LOS ARTICLES-->
    <h4>Información de utilidad del país</h4> <!--puedo meter el h4 dentro: section>h4+article o similar-->
    <section>
        <?php
    ...
    <h3>Mapa dinámico</h3>
    <div>
        <h5>Aquí se mostrará el mapa dinámico</h5>
