...
def generar_svg(archivoXML, archivoSVG, ancho=600, alto=300):
    ...
    with open(archivoSVG, 'w') as svg:  #Creo el .svg de altimetría
        ...
        svg.write(f'<svg xmlns="http://www.w3.org/2000/svg" version="2.0" width="{ancho}" height="{alto}">\n')
...
#
def main():
    generar_svg('circuitoEsquema.xml', 'altimetria.svg', ancho=450, alto=225)  #ancho=600, alto=300
